...
public class FrAddCP extends javax.swing.JFrame {
    ...
    public FrAddCP(int kt, CoPhieu cp) throws HeadlessException {
        this.kt = kt;
        initComponents();
        ...
        {
            jTextFieldMCP.setEditable(false);
            jTextFieldCongTy.setEditable(false);
            jTextFieldDiaChi.setEditable(false);
            jTextFieldDiaChiWeb.setEditable(false);
            jTextFieldEmail.setEditable(false);
            jTextFieldFax.setEditable(false);
            jComboBoxMaSan.setEditable(false);
            jTextFieldSDT.setEditable(false);
            jTextFieldSoLg.setEditable(false);
            jPanel1.remove(jButtonCa);
            jButtonXN.setText("Back");
        }
    }
    ...
    if(kt != 3) {
        if (jTextFieldMCP.getText().trim().length() == 0 || jTextFieldMCP.getText().trim().length()>6) {
            JOptionPane.showMessageDialog(this, "Mã CP không hợp lệ");
            return;
        }
        ...
        else if(kt==1)
        {
            ...
            addCoPhieu(new CoPhieu(jTextFieldMCP.getText(), jComboBoxMaSan.getItemAt(jComboBoxMaSan.getSelectedIndex()), jTextFieldCongTy.getText(), jTextFieldDiaChi.getText(), jTextFieldSDT.getText(), jTextFieldFax.getText(), jTextFieldDiaChiWeb.getText(), jTextFieldEmail.getText(), Integer.valueOf(jTextFieldSoLg.getText())));
        ...
        else
        {
            ...
            updateCP(new CoPhieu(jTextFieldMCP.getText(), jComboBoxMaSan.getItemAt(jComboBoxMaSan.getSelectedIndex()), jTextFieldCongTy.getText(), jTextFieldDiaChi.getText(), jTextFieldSDT.getText(), jTextFieldFax.getText(), jTextFieldDiaChiWeb.getText(), jTextFieldEmail.getText(), Integer.valueOf(jTextFieldSoLg.getText())));
            JOptionPane.showMessageDialog(this, "SUCCES");
            this.setVisible(false);
