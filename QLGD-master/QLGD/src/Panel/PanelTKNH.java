...
public class PanelTKNH extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                ...
                .addComponent(jButtonAddTKNN, javax.swing.GroupLayout.PREFERRED_SIZE, 101, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(18, 18, 18)
                .addComponent(jButtonDelTKNN, javax.swing.GroupLayout.PREFERRED_SIZE, 100, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(18, 18, 18)
                .addComponent(jButtonRF, javax.swing.GroupLayout.PREFERRED_SIZE, 100, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(573, 573, 573))
        );
    ...
    {
        int kt=0;
        String sql = "SELECT * FROM LenhDat WHERE MaTKNH ='"+maTKNH+"'";
        try {
            PreparedStatement ps = ketNoi.prepareStatement(sql);
            ResultSet rs=ps.executeQuery();
            if(rs.next())
    ...
    private void jButtonDelTKNNActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonDelTKNNActionPerformed
        ...
        int kt=ktTKNH(maTKNH);
        if(kt==1)
        {
            JOptionPane.showMessageDialog(this, "TKNH Này Đã Đặt Lệnh");
            return;
        }
        else  if(kt==2)
        {
            JOptionPane.showMessageDialog(this, "TKNH Này Đang Chờ Cập Nhật Tiền");
            return;
        }
