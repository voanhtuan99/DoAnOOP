...
public class PanelDSLenh extends javax.swing.JPanel {
  ...
  public void layDataLenhDat() {
        ...
        Vector vt;
        String sql = "select * from LenhDat ORDER BY NgayGioDat DESC";
        try {
    ...
    private void initComponents() {
        ...
        jTableDSLenh.getColumnModel().getColumn(2).setPreferredWidth(30);
        jTableDSLenh.getColumnModel().getColumn(7).setPreferredWidth(30);
        jTableDSLenh.getColumnModel().getColumn(8).setPreferredWidth(30);

        jButtonRF.setText("Refesh");
        jButtonRF.setPreferredSize(new java.awt.Dimension(100, 25));
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGap(18, 18, 18)
                .addComponent(jButtonRF, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void jButtonHuyLenhActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonHuyLenhActionPerformed
        ...
        else if("KH".equals(ld.getMaTrangThai()) || "CAK".equals(ld.getMaTrangThai()) || "DH".equals(ld.getMaTrangThai()))
        {
            System.out.println(ld.getMaTrangThai());
            JOptionPane.showMessageDialog(this, "Lệnh Này Không Đc Huy");
            return;
        }
...
//        ld.setGiaDat(floatNumber);
        //System.out.println(parse("$199.00",Locale.US));
        
        String temp=dtm.getValueAt(jTableDSLenh.getSelectedRow(), 5).toString();
        ...
        ld.setGiaDat(Float.parseFloat(temp.substring(0,temp.length()-2)));
